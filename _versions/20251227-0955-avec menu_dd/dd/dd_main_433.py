"""
dd_main_433.py v6.0.0 - Programme DD avec Radio 433MHz
Module: WROVER-T7 ou WROOM-32
Communication: UART GT38 433MHz
...
Basé sur dd_main.py v4.9.0 (ancien mode 433)
Adapté pour fonctionner avec système menu NVS
"""
...
def main():
    ...
    print("-" * 70)
    print("DTD v1.1.0 433MHz | ID={:02d} | Module: WROVER-T7".format(DD_ID))
