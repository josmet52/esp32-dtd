"""
ta_radio_espnow.py - Module radio ESP-NOW (v5.0.0 - SANS WiFi)
Communication sans fil avec les DD via ESP-NOW

VERSION SANS WiFi:
- Pas de connexion WiFi
- Pas de RSSI disponible
- ESP-NOW pur pour performance maximale
- Stable et rapide

Pour version AVEC WiFi et RSSI, voir v5.1.0

Changements v5.0.0:
- Suppression complète de la gestion WiFi
- ESP-NOW uniquement
