"""
Project: DTD - ta_app.py v3.1.2
Mode portrait uniquement - Surveillance détecteurs ESP-NOW

Changements v3.1.2:
- Correction: Appel get_stats() au lieu d'accès direct à stats
  pour avoir avg_rssi calculé correctement

Changements v3.1.1:
- Passage RSSI moyen à l'UI pour affichage en zone version

Changements v3.1.0:
- Passage RSSI à l'UI pour affichage sur barres DD
- Passage infos batterie à l'UI pour affichage en zone version

Changements v3.0.0:
- Remplacement Radio433 par RadioESPNow
- Import de ta_radio_espnow au lieu de ta_radio_433
- RSSI disponible pour chaque DD
- Reste du code identique à v2.8.0
"""
...
from ta_radio_espnow import RadioESPNow as Radio  # ← CHANGEMENT ICI
...
class TaApp:
    def __init__(self, tft=None, ui=None, radio=None, button_manager=None):
        ...
        # Radio ESP-NOW
        self.radio = radio if radio else Radio(config.RADIO, logger, ui=self.ui)
