...
# VERSION
# ============================================================================
# Informations de version affichées à l'écran et dans les logs

APP_NAME = "TA-espnow"       # Nom de l'application
APP_VERSION = "2.5.0"          # Numéro de version
APP_DATE = "09.12.2025"        # Date de la version
...
COLORS = {
    "C_BLACK": amoled.BLACK,                         # Noir (fond)
    "C_WHITE": amoled.WHITE,                         # Blanc (texte)
