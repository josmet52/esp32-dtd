# ta_radio_433.py - Module radio 433MHz (v3.5.0 MODE SÉQUENTIEL)
# VERSION SÉQUENTIEL UNIQUEMENT
# Protocole: POLL:XX -> ACK:XX:Y
# 
# Modifications v3.5.0:
# - Ajout méthode get_rssi() pour compatibilité ESP-NOW (retourne None)
#
# Modifications v3.4.0:
# - Suppression complète du mode SYNC
# - Conservation uniquement du mode séquentiel (SEQ)
