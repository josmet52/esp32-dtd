"""
ta_ota.py v1.2.2 - Mode OTA pour TA
Amélioration UX et demande d'annonce UDP

v1.2.2:
- Désactivation bouton Flash tant que OTA:START pas fait
- Commande UDP pour forcer annonce immédiate des DD
- Amélioration feedback utilisateur
v1.2.1:
- Amélioration affichage statut DD (distingue "Online sans IP" de "Offline")
- Logs UDP améliorés pour debug
v1.2.0:
- Ajout détection bouton UP long (3s) pour retour en mode normal
"""
