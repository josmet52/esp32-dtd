"""
Project: DTD - ta_app.py v3.2.2
Mode portrait uniquement - Surveillance détecteurs ESP-NOW

Changements v3.2.2:
- Ne pas initialiser l'affichage si hardware en erreur
- L'écran rouge d'erreur reste visible
- Pas d'écrasement par les barres DD

Changements v3.2.1:
- Blocage système propre si hardware ESP-NOW non disponible
"""
