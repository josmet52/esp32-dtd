"""
project : DTD
file: tft_config_amoled.py - Configuration pour T-Display-S3 AMOLED

author: jom52
email: jom52.dev@gmail.com
github: https://github.com/JOM52/esp32-dtd

Version migrée: rm67162 → amoled natif
Date migration: 08.11.2025

Configuration AMOLED complète avec:
- Module amoled natif LilyGo
- QSPIPanel avec 4 lignes de données
- GPIO38 (TFT_CDE) pour alimentation écran
...
# Constantes de couleur RGB565 (compatibles amoled)
BLACK   = amoled.BLACK
WHITE   = amoled.WHITE
RED     = amoled.RED
GREEN   = amoled.GREEN
BLUE    = amoled.BLUE
YELLOW  = amoled.YELLOW
CYAN    = amoled.CYAN
MAGENTA = amoled.MAGENTA
...
def color565(r, g, b):
    """
    Convertit RGB (0-255) en format RGB565
